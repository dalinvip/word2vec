...
if __name__ == "__main__":
    ...
    # feat_file = "./Data/char_radical.txt"
    feat_file = "./Data/char_component.txt"
    out_file = "./Data/giga_subcomponent.300d.source_feat.txt"
    source_embed = "./Data/giga_subcomponent.300d.source"
    feat_embed = "./Data/giga_subcomponent.300d.feature"
